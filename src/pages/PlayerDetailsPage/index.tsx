...
const PlayerDetailsPage = () => {
    ...
    const playerQuery = useQuery({
        queryKey: ["player", id],
        queryFn: () => getPlayer({ id: id as string }),
    });

    const checkupsQuery = useQuery({
        queryKey: ["playerCheckups", id],
        queryFn: () => getCheckups({ page, playerId: id }),
    });
    ...
    const onDeleteCheckup = useCallback(
        (checkup: ICheckup) => {
            openModal({
                ...
                title: "Confirmación",
                extraData: { type: "DeleteCheckup", data: checkup, queryKey: ["playerCheckups", id as string] },
            });
        },
        [id]
    );
